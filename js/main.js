...
var sites = [['', 51.104411, 17.01300, 1]];
...
var overlay = {
    ...
    open: function(url, element) {
        ...
        if (/\.(jpg|png|gif|jpeg)$/.test(url)) {
            ...
            response = '<section id="gallery"><div class="gallery-content fullscreen"><a class="close-button"><i class="fa fa-times-circle"></i></a><div class="gallery"><div class="loading-spinner"></div><div id="images" class="owl-carousel owl-theme">'+response+'</div><div class="controls"></div></div></div></section>';
